...
#Models
number_of_models = 1  # number of models to compare - if set to 1 ignores model 2

model_1_inputs = {"m1_time": 100,  # time the first model runs for [hr]
                  "m1_continous_dose_amount": 1,  # |Dose| [ng]
                  "m1_instantaneous_dose_amount": 0,  # |Dose| [ng]
                  "m1_dose_times": [],  # (t) in Dose(t) [hours]
                  "m1_dose_entry": 'intravenous bolus',  # subcutaneous or intravenous bolus

                  "m1_number_of_compartments": 1,  # number of peripheral compartments
                  ...
                  "m1_volume_2": 0,  # V_{p2} [mL]
                  "m1_q_2_initial": 0,  # q_{p2}(t=0) [ng]
                  "m1_flux_2": 0,  # Q_{p2} [mL/hour]

                  "m1_k_a": 0,  # k_a [/hour]
                  "m1_q_0_initial": 0}  # q_0(t=0) [ng]
...
model_2_inputs = {"m2_time": 100,  # time the first model runs for
                  ...
                  "m2_dose_times": [0,0.5,1],  # (t) in Dose(t) [hours]
                  "m2_dose_entry": 'subcutaneous',  # subcutaneous or intravenous bolus

                  "m2_number_of_compartments": 1,  # number of peripheral compartments
