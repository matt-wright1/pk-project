"""Example inputs used to compare 2 models: one with a dosing compartment and one without.
...
model_1_inputs = {"m1_time": 100,  #time the first model runs for
                  "m1_continous_dose_amount": 1,  # |Dose| [ng/hr]
                  "m1_instantaneous_dose_amount": 0,  # |Dose| [ng]
                  "m1_dose_times": [0],  #(t) in Dose(t) [hours]
...
model_2_inputs = {"m2_time": 100, #time the first model runs for
                  ...
                  "m2_dose_times": [0], #(t) in Dose(t) [hours]
