...
model_2_inputs = {"m2_time": 100,  # time the first model runs for
                  ...
                  "m2_dose_times": [],  # (t) in Dose(t) [hours]
                  "m2_dose_entry": 'intravenous bolus',  # subcutaneous or intravenous bolus
                  ...
                  "m2_volume_2": 0,  # V_{p2} [mL]
                  "m2_q_2_initial": 0,  # q_{p2}(t=0) [ng]
                  "m2_flux_2": 0,  # Q_{p2} [mL/hour]

                  "m2_k_a": 0,  # k_a [/hour]
                  "m2_q_0_initial": 0}  # q_0(t=0) [ng]
