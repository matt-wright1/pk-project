...
class CompartmentTest(unittest.TestCase):
    ...
    def test_compartment_defaults(self):
        ...
        self.assertEqual([TestComp.v, TestComp.q], [0, 0])
    ...
    def test_dose_defaults(self):
        ...
        """
        TestCent = Central()
        self.assertEqual([TestCent.v, TestCent.q, TestCent.CL], [0, 0, 0])
    ...
    def test_peripheral_defaults(self):
        ...
        """
        TestPeri = Peripheral()
        self.assertEqual([TestPeri.v, TestPeri.q, TestPeri.Q], [0, 0, 0])
    ...
    def test_dosing_defaults(self):
        ...
        """
        TestDosn = Dosing()
        self.assertEqual([TestDosn.v, TestDosn.q, TestDosn.ka], [0, 0, 0])
